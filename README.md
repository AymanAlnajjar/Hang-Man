...
**Dictionary:** the grid game validates against ~18,000 common Arabic words. A
small curated list in [`lib/dictionary.ts`](./lib/dictionary.ts) loads instantly,
and the big list ([`public/ar-words.txt`](./public/ar-words.txt), ~200 KB) is
